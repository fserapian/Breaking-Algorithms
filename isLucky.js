...
// One liner
const isLucky3 = (n) =>
    n.toString().slice(0, n.toString().length / 2).split('').reduce((acc, el) => acc + +el, 0) ===
    n.toString().slice(n.toString().length / 2).split('').reduce((acc, el) => acc + +el, 0);
...
console.log(isLucky3(1230));
console.log(isLucky3(239017));
