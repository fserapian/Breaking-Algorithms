...
function companyBotStrategy1(data) {
  let answerTime = 0;
  let correctness = 0;
...
console.log(companyBotStrategy(arr1));
console.log(companyBotStrategy1(arr1));
console.log(companyBotStrategy(arr2));
console.log(companyBotStrategy1(arr2));
console.log(companyBotStrategy(arr3));
console.log(companyBotStrategy1(arr3));
